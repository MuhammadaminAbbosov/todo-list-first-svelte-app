...
var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "empty svelte-tuwkas");
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-tuwkas");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(img, "click", /*handleChecked*/ ctx[2].bind(this, /*index*/ ctx[9]), false, false, false);
    				mounted = true;
    			}
    		},
    ...
    function create_each_block(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = !/*todo*/ ctx[7].checked && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			img = element("img");
    			t3 = space();
    			attr_dev(p, "class", "svelte-tuwkas");
    			...
    			attr_dev(div, "class", "todo svelte-tuwkas");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(img, "click", /*handleRemove*/ ctx[3].bind(this, /*index*/ ctx[9]), false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*checkedTodos*/ 1 && t0_value !== (t0_value = /*todo*/ ctx[7].title + "")) set_data_dev(t0, t0_value);

    			if (dirty & /*checkedTodos*/ 1) {
    				toggle_class(p, "checked", /*todo*/ ctx[7].checked);
    			}

    			if (!/*todo*/ ctx[7].checked) {
    				if (if_block) {
    ...
    function create_fragment(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let each_value = /*checkedTodos*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h3, "class", "svelte-tuwkas");
    			add_location(h3, file, 49, 2, 1071);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-tuwkas");
    			...
    			attr_dev(select, "class", "svelte-tuwkas");
    			add_location(select, file, 53, 4, 1196);
    			attr_dev(form, "class", "svelte-tuwkas");
    			add_location(form, file, 50, 2, 1092);
    			attr_dev(div0, "class", "todos svelte-tuwkas");
    			add_location(div0, file, 59, 2, 1390);
    			attr_dev(div1, "class", "main svelte-tuwkas");
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(select, "change", /*handleChange*/ ctx[4], false, false, false),
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*handleRemove, handleChecked, checkedTodos*/ 13) {
    				each_value = /*checkedTodos*/ ctx[0];
    				validate_each_argument(each_value);
    				let i;
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	function handleChecked(id) {
    		$$invalidate(5, todos[id].checked = true, todos);
    		$$invalidate(0, checkedTodos = [...todos]);
    	}
    	...
    	function handleChange(e) {
    		$$invalidate(6, type = e.target.value);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('checkedTodos' in $$props) $$invalidate(0, checkedTodos = $$props.checkedTodos);
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*type, todos*/ 96) {
    			if (type === "done") {
    				$$invalidate(0, checkedTodos = todos.filter(item => item.checked));
    			} else if (type === "all") {
    				$$invalidate(0, checkedTodos = [...todos]);
